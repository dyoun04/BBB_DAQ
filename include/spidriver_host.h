...
#pragma DATA_SECTION(pru0_sharedram, ".data_buf")
#pragma RETAIN(pru0_sharedram)
static uint32_t *pru0_sharedram;

// Global pointer to base of PRU1 RAM.  Must fix this later.
#pragma DATA_SECTION(pru1_sharedram, ".data_buf1")
#pragma RETAIN(pru1_sharedram)
static uint32_t *pru1_sharedram;
